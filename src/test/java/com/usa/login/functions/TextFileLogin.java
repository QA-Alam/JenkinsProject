...
public class TextFileLogin {
	...
	public void getpropertiesfile() throws Throwable {
		...
		if (browserName.equalsIgnoreCase("chrome")) {
			...
			String chromeDriverPath = "/Applications/chromedriver";
	...
	public void textFileLogin() throws Throwable {
		getpropertiesfile();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id='input-email-address']")).sendKeys(prop.getProperty("userName"));
		driver.findElement(By.xpath("//*[@id='input-password']")).sendKeys(prop.getProperty("textPassword"));
		Thread.sleep(5000);
